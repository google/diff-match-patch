...
namespace DiffMatchPatch
{
    ...
    {
        /// <summary>JScript splice function.</summary>
        ...
        /// <summary>Java substring function.</summary>
    ...
    /// <summary>
    /// The data structure representing a diff is a List of <see cref="Diff"/> objects:
    ...
    {
        /// <summary>
        /// Diff(Operation.DELETE, "Hello") means: delete "Hello".
        /// </summary>
        DELETE,

        /// <summary>
        /// Diff(Operation.INSERT, "Goodbye") means add "Goodbye.
        /// </summary>
        INSERT,

        /// <summary>
        /// Diff(Operation.EQUAL, " world.") means keep " world.".
        /// </summary>
        EQUAL
    }
    ...
    public class Diff
    {
        ...
        /// <summary>
        /// Is this <see cref="Diff"/> equivalent to another <see cref="Diff"/>?
        /// </summary>
        /// <param name="obj">Another <see cref="Diff"/> to compare against.</param>
        /// <returns><see langword="true"/> or <see langword="true"/>.</returns>
    ...
    public class Patch
    {
        ...
        /// <summary>
        /// <para>Emulate GNU diff's format.</para>
        /// <para>Header: @@ -382,8 +481,9 @@</para>
        /// <para>Indices are printed as 1-based, not 0-based.</para>
        /// </summary>
    ...
    public class diff_match_patch
    {
        ...
        /// </summary>
        /// <param name="text1">Old <see cref="string"/> to be diffed.</param>
        /// <param name="text2">New <see cref="string"/> to be diffed.</param>
        /// <returns>List of <see cref="Diff"/> objects.</returns>
        ...
        /// </param>
        /// <param name="deadline">Used internally for recursive calls.Users should set DiffTimeout instead.</param>
        /// <returns>List of <see cref="Diff"/> objects.</returns>
        ...
        /// <param name="deadline">Time at which to bail if not yet complete.</param>
        /// <returns>LinkedList of <see cref="Diff"/> objects.</returns>
        ...
        /// <returns>Three element <see cref="object"/> array, containing the encoded text1, the encoded text2 and the List of unique strings.
        /// The zeroth element of the List of unique strings is intentionally blank.</returns>
        ...
        /// <param name="text2">Second string.</param>
        /// <returns>
        /// Five element <see cref="string"/> array,
        /// containing the prefix of <paramref name="text1"/>,
        /// the suffix of <paramref name="text1"/>,
        /// the prefix of <paramref name="text2"/>,
        /// the suffix of <paramref name="text2"/>
        /// and the common middle.
        /// Or <see langword="null"/> if there was no match.
        /// </returns>
        ...
        /// <summary>
        /// Does a Substring of <paramref name="shorttext"/> exist within <paramref name="longtext"/>
        /// such that the Substring is at least half the length of longtext?
        /// </summary>
        ...
        /// <returns>
        /// Five element <see cref="string"/> array,
        /// containing the prefix of <paramref name="longtext"/>,
        /// the suffix of <paramref name="longtext"/>,
        /// the prefix of <paramref name="shorttext"/>,
        /// the suffix of <paramref name="shorttext"/>
        /// and the common middle.
        /// Or <see langword="null"/> if there was no match.
        /// </returns>
        ...
        /// </summary>
        /// <param name="diffs">List of <see cref="Diff"/> objects.</param>
        ...
        /// </summary>
        /// <param name="one">First <see cref="string"/>.</param>
        /// <param name="two">Second <see cref="string"/>.</param>
        ...
        /// <summary>
        /// <paramref name="loc"/> is a location in text1,
        /// compute and return the equivalent location in text2.
        /// </summary>
        /// <param name="diffs">List of <see cref="Diff"/> objects.</param>
        ...
        /// <summary>
        /// Given the original <paramref name="text1"/>, and an encoded string
        /// which describes the operations required to transform <paramref name="text1"/>
        /// into text2, compute the full diff.
        /// </summary>
        ...
        /// <summary>
        /// Locate the best instance of <paramref name="pattern"/>
        /// in <paramref name="text"/> near <paramref name="loc"/>.
        ...
        /// <summary>
        /// Compute and return the score for a match with
        /// <paramref name="e"/> errors and <paramref name="x"/> location.
        /// </summary>
        ...
        /// but don't let the pattern expand beyond <see cref="Match_MaxBits"/>.
        /// </summary>
        ...
        /// <summary>
        /// Compute a list of patches to turn <paramref name="text1"/>
        /// into <paramref name="text2"/>.
        /// A set of diffs will be computed.
        /// </summary>
        /// <param name="text1">Old text.</param>
        /// <param name="text2">New text.</param>
        /// <returns>List of <see cref="Patch"/> objects.</returns>
        ...
        /// <summary>
        /// Compute a list of patches to turn
        /// <paramref name="text1"/> into <paramref name="text2"/>.
        /// <paramref name="text2"/> is ignored,
        /// <paramref name="diffs"/> are the delta between
        /// <paramref name="text1"/> and <paramref name="text2"/>.
        /// </summary>
        /// <param name="text1">Old text</param>
        /// <param name="text2">Ignored.</param>
        /// <param name="diffs">
        /// Array of Diff objects for
        /// <paramref name="text1"/> to <paramref name="text2"/>.
        /// </param>
        /// <returns>List of <see cref="Patch"/> objects.</returns>
        ...
        /// <summary>
        /// Compute a list of patches to turn
        /// <paramref name="text1"/> into text2.
        /// text2 is not provided, <paramref name="diffs"/> are the delta
        /// between <paramref name="text1"/> and text2.
        /// </summary>
        /// <param name="text1">Old text.</param>
        /// <param name="diffs">Array of Diff objects for <paramref name="text1"/> to text2.</param>
        ...
        /// </summary>
        /// <param name="patches">Array of <see cref="Patch"/> objects.</param>
        /// <returns>Array of <see cref="Patch"/> objects.</returns>
        ...
        /// <summary>
        /// Merge a set of <paramref name="patches"/> onto the text.
        /// Return a patched text, as well as an array of true/false values
        /// indicating which patches were applied.
        /// </summary>
        /// <param name="patches">Array of <see cref="Patch"/> objects</param>
        /// <param name="text">Old text.</param>
        /// <returns>Two-element <see cref="object"/> array, containing the new text
        /// and an array of <see cref="bool"/> values.</returns>
        ...
        /// Intended to be called only from within <see cref="patch_apply(List{Patch}, string)"/>.
        /// </summary>
        /// <param name="patches">Array of <see cref="Patch"/> objects.</param>
        ...
        /// Intended to be called only from within <see cref="patch_apply(List{Patch}, string)"/>.
        /// </summary>
        /// <param name="patches">List of <see cref="Patch"/> objects.</param>
        ...
        /// <summary>
        /// Take a list of <paramref name="patches"/> and return a textual representation.
        /// </summary>
        /// <param name="patches">List of <see cref="Patch"/> objects.</param>
        ...
        /// <summary>
        /// Parse a textual representation of patches and return a List of <see cref="Patch"/> objects.
        /// </summary>
        ...
        /// <summary>
        /// Encodes a <see cref="string"/> with URI-style % escaping.
        /// Compatible with JavaScript's encodeURI function.
        /// </summary>
        /// <param name="str">The <see cref="string"/> to encode.</param>
