...
export default class diff_match_patch {
  ...
  diff_halfMatch_(text1: string, text2: string): string[] | null {
     ...
     * @private
     */
    function diff_halfMatchI_(longtext: string,
        shorttext: string, i: number): string[] | null {
      // Start with a 1/4 length substring at position i as a seed.
      var seed = longtext.substring(i, i + Math.floor(longtext.length / 4));
      var j = -1;
      var best_common = '';
      var best_longtext_a: string | null = null;
      var best_longtext_b: string | null = null;
      var best_shorttext_a: string | null = null;
      var best_shorttext_b: string | null = null;
