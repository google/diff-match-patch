    ...
    var diff_match_patch = (function () {
        ...
        diff_match_patch.prototype.diff_compute_ = function (text1, text2, checklines, deadline) {
            ...
            if (i != -1) {
                ...
                if (text1.length > text2.length) {
                    diffs[0][0] = diffs[2][0] = exports.DIFF_DELETE;
                }
                return diffs;
            }
        ...
        diff_match_patch.prototype.diff_halfMatch_ = function (text1, text2) {
            ...
            function diff_halfMatchI_(longtext, shorttext, i) {
                ...
                var j = -1;
                var best_common = '';
                var best_longtext_a = null;
                var best_longtext_b = null;
                var best_shorttext_a = null;
                var best_shorttext_b = null;
        ...
        diff_match_patch.prototype.diff_cleanupSemantic = function (diffs) {
            ...
            while (pointer < diffs.length) {
                if (diffs[pointer][0] == exports.DIFF_EQUAL) {
                    ...
                    if (diffs[pointer][0] == exports.DIFF_INSERT) {
                    ...
                    if (lastEquality && (lastEquality.length <=
                        ...
                        diffs[equalities[equalitiesLength - 1] + 1][0] = exports.DIFF_INSERT;
                        equalitiesLength--;
                        equalitiesLength--;
            ...
            pointer = 1;
            while (pointer < diffs.length) {
                if (diffs[pointer - 1][0] == exports.DIFF_DELETE &&
                    diffs[pointer][0] == exports.DIFF_INSERT) {
                    ...
                    if (overlap_length1 >= overlap_length2) {
                        ...
                        if (overlap_length2 >= deletion.length / 2 ||
                            ...
                            diffs[pointer - 1][0] = exports.DIFF_INSERT;
                            diffs[pointer - 1][1] =
                                insertion.substring(0, insertion.length - overlap_length2);
                            diffs[pointer + 1][0] = exports.DIFF_DELETE;
                            diffs[pointer + 1][1] =
        ...
        diff_match_patch.prototype.diff_cleanupSemanticLossless = function (diffs) {
            ...
            while (pointer < diffs.length - 1) {
                if (diffs[pointer - 1][0] == exports.DIFF_EQUAL &&
                    diffs[pointer + 1][0] == exports.DIFF_EQUAL) {
        ...
        diff_match_patch.prototype.diff_cleanupEfficiency = function (diffs) {
            ...
            while (pointer < diffs.length) {
                if (diffs[pointer][0] == exports.DIFF_EQUAL) {
                    ...
                    if (diffs[pointer][0] == exports.DIFF_DELETE) {
                        post_del = 1;
                    }
                    else {
                        post_ins = 1;
            ...
            while (pointer < diffs.length) {
                switch (diffs[pointer][0]) {
                    ...
                    case exports.DIFF_EQUAL:
                        ...
                        else if (pointer !== 0 && diffs[pointer - 1][0] == exports.DIFF_EQUAL) {
        ...
        diff_match_patch.prototype.diff_xIndex = function (diffs, loc) {
            ...
            for (x = 0; x < diffs.length; x++) {
                if (diffs[x][0] !== exports.DIFF_INSERT) {
                    chars1 += diffs[x][1].length;
                }
                if (diffs[x][0] !== exports.DIFF_DELETE) {
            ...
            if (diffs.length != x && diffs[x][0] === exports.DIFF_DELETE) {
                return last_chars2;
            }
                    ...
                    if (text1 == text2) {
                        ...
                        if (text1.length > this.Match_MaxBits &&
                            ...
                            for (var y = 0; y < patches[x].diffs.length; y++) {
                                ...
                                if (mod[0] !== exports.DIFF_EQUAL) {
                                    index2 = this.diff_xIndex(diffs, index1);
                                }
                                if (mod[0] === exports.DIFF_INSERT) {
                                    text = text.substring(0, start_loc + index2) + mod[1] +
                                        text.substring(start_loc + index2);
                                }
                                else if (mod[0] === exports.DIFF_DELETE) {
                                    text = text.substring(0, start_loc + index2) +
                                        text.substring(start_loc + this.diff_xIndex(diffs, index1 + mod[1].length));
                                }
                                if (mod[0] !== exports.DIFF_DELETE) {
                                    index1 += mod[1].length;
                                }
                            }
                        }
        ...
        diff_match_patch.prototype.patch_addPadding = function (patches) {
            ...
            if (diffs.length == 0 || diffs[0][0] != exports.DIFF_EQUAL) {
            ...
            diffs = patch.diffs;
            if (diffs.length == 0 || diffs[diffs.length - 1][0] != exports.DIFF_EQUAL) {
                ...
                while (bigpatch.diffs.length !== 0) {
                    ...
                    while (bigpatch.diffs.length !== 0 &&
                        ...
                        if (diff_type === exports.DIFF_INSERT) {
                            ...
                            patch.diffs[0][0] == exports.DIFF_EQUAL &&
                    ...
                    if (postcontext !== '') {
                        ...
                        if (patch.diffs.length !== 0 &&
                            patch.diffs[patch.diffs.length - 1][0] === exports.DIFF_EQUAL) {
