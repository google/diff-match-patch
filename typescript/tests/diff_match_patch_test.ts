...
export function testDiffCharsToLines() {
    ...
    var diffs: Diff[] = [[DIFF_EQUAL, '\x01\x02\x01'], [DIFF_INSERT, '\x02\x01\x02']];
    ...
    assertEquals(n, chars.length);
    lineList.unshift('');
    var diffs: Diff[] = [[DIFF_DELETE, chars]];
...
export function testDiffText() {
    ...
    var diffs: Diff[] = [[DIFF_EQUAL, 'jump'], [DIFF_DELETE, 's'], [DIFF_INSERT, 'ed'], [DIFF_EQUAL, ' over '], [DIFF_DELETE, 'the'], [DIFF_INSERT, 'a'], [DIFF_EQUAL, ' lazy']];
